...
BUNDLE_DIR = ROOT / "strategy_deploy_bundle"
...
from obs_builder import ObsBuilder  # noqa: E402
from safety_guard import SafetyGuard  # noqa: E402
from robotio_bridge import RobotIOBridge  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--config", default="strategy_deploy_bundle/config/wavego_deploy_config.yaml")
